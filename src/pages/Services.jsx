...
const services = [
  ...
  },
  {
    title: "Laptop Repair",
    icon: "💻",
    desc: "Hardware and software fixes for laptops.",
  },
  {
    title: "Desktop Repair",
    icon: "🖥️",
    desc: "Desktop troubleshooting and upgrades.",
  },
  {
    title: "Printer Repair",
    icon: "🖨️",
    desc: "Printer maintenance and cartridge support.",
  },
  {
    title: "CCTV Installation",
    icon: "📹",
    desc: "CCTV setup and surveillance solutions.",
  },
  {
  ...
  },
  {
    ...
    icon: "🛠️",
    desc: "Windows/Linux OS installs and tuning.",
  },
  {
    title: "Data Recovery",
    icon: "🔁",
    desc: "Recover lost or corrupted data.",
  },
  {
  ...
  },
  {
    ...
    icon: "🔬",
    desc: "Advanced board-level diagnostics.",
  },
  {
    title: "Server Maintenance",
    icon: "🗄️",
    desc: "Server monitoring and upkeep.",
  },
  {
    title: "Custom PC Build",
    icon: "⚙️",
    desc: "Custom gaming and workstation builds.",
  },
  {
    title: "Antivirus Installation",
    icon: "🛡️",
    desc: "Security setup and malware removal.",
  },
  {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        ...
        <p className="mt-2 text-gray-600">
          Comprehensive IT services for businesses and home users.
        </p>
